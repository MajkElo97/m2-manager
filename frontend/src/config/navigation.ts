...
export const mainNavigation: NavigationItem[] = [
  ...
  { label: 'Finanse', path: '/finance', icon: Wallet, requiredPermission: 'FINANCES_VIEW' },
  { label: 'Magazyn', path: '/inventory', icon: Warehouse, requiredPermission: 'WAREHOUSE_VIEW' },
...
export const appRoutes: AppRoute[] = [
  ...
  { path: '/finance', moduleName: 'Finanse' },
  { path: '/inventory', moduleName: 'Magazyn' },
  { path: '/fleet', moduleName: 'Flota' },
