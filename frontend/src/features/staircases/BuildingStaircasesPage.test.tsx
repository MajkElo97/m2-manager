...
function BuildingStaircasesPageHarness() {
...
function renderBuildingStaircasesPage(permissions: string[] = ['BUILDINGS_VIEW', 'BUILDINGS_EDIT']) {
  return renderWithProviders(<BuildingStaircasesPageHarness />, {
...
describe('BuildingStaircasesPage', () => {
  beforeEach(() => {
  ...
  it('shows add button when user has BUILDINGS_EDIT permission', async () => {
    renderBuildingStaircasesPage(['BUILDINGS_VIEW', 'BUILDINGS_EDIT']);
  ...
  it('hides add button when user lacks BUILDINGS_EDIT permission', async () => {
    renderBuildingStaircasesPage(['BUILDINGS_VIEW']);
